...
import { LogOut, BookOpen, BarChart2, Layout as LayoutIcon, Bell } from 'lucide-react';
          ...
          <nav className="flex flex-col gap-2">
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                currentView === 'home' ? 'bg-primary/20 text-primary border border-primary/30' : 'text-slate-400 hover:bg-dark-700 hover:text-white'
              }`}
            >
              <LayoutIcon size={20} />
            ...
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                currentView === 'assignments' ? 'bg-primary/20 text-primary border border-primary/30' : 'text-slate-400 hover:bg-dark-700 hover:text-white'
              }`}
            >
              <BookOpen size={20} />
             ...
             {user.role === UserRole.TEACHER && (
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                    currentView === 'students' ? 'bg-primary/20 text-primary border border-primary/30' : 'text-slate-400 hover:bg-dark-700 hover:text-white'
                }`}
                >
                <BarChart2 size={20} />
